...
import entities.DefaultInteractableIDs;
...
/**
 * entities.characters.Goblin.txt class, an enemy that speaks to you. The entities.characters.Goblin.txt prompts the user to enroll in his mini-game for some reward
 * but will only do so with a magic message! The entities.characters.Goblin.txt's reward is up to the specific circumstance.
 */
public class RiddleGoblin extends Goblin {
    ...
    /**
     * Speak from Talklable interface, in this case the entities.characters.Goblin does not speak on his own
     *
     ...
     * The entities.characters.Goblin listens for the magic message, then responds with a mini-game
     *
